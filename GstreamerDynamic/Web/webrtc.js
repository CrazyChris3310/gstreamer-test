...
function websocketServerConnect() {
    ...
    if (window.location.protocol.startsWith ("file")) {
        ...
        ws_server = ws_server || "172.16.0.102";
    ...
    ws_conn.onerror = onServerError;
    ws_conn.onmessage = onServerMessage;
    ws_conn.onclose = onServerClose;
}
...
function doConnect() {
    ws_conn.send('SESSION ' + document.getElementById('txtOtherSid').value);
}
